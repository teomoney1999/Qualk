                ...
                <nav class="site-navigation text-right" role="navigation">
                  <div class="container">
                    ...
                    <ul class="site-menu js-clone-nav d-none d-lg-block">
                      <li class="active"><a href="${ pageContext.request.contextPath }/categories">For Candidates</a></li>
                      <li class="has-children">
                        <a href="${ pageContext.request.contextPath }/categories">For Employees</a>
                        <ul class="dropdown arrow-top">
                          <li class="active"><a href="${ pageContext.request.contextPath }/categories">Category</a></li>
