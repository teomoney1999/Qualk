...
<html lang="en">
  ...
  <jsp:useBean id="helloBean" class="qualk.beans.Form"></jsp:useBean>
  <
      ...
      <section class='cv-header'>
        <div class='container cv-header-container'>
            <div class='row cv-header-row'>
                ...
                <a class='sign-out' href='${ pageContext.request.contextPath }/signOut'><button type='submit' class='signout-btn active'>Sign Out</button></a>
    ...
    <section class='cv'>
        <div class='container section-container'>
            <div class='row cv-row'>
                <div class='col-md-3 title'>
                    <h1 class='title-name'>Account</h1>
                </div>
        ...
        <div class='container section-container'>
            <div class='row cv-row'>
                ...
                <div class='col-md-4 trust-reach'>
                    <h2 class='info-key'>Trust phone numbers</h2>
        ...
        <div class='container section-container'>
            <div class='row cv-row'>
                <div class='col-md-3 title'>
                    <h1 class='title-name'>CV</h1>
                </div>
                <div class='col-md-9 info'>
                    <h2 class='info-key'>Your CV</h2>
                    <p class='info-value'>
                        <a href='#'><button class='upload-btn'>Upload your CV info</button></a>
                    </p>
