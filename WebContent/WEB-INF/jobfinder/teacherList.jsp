                    ...
                    <div class='list'>
                        ...
                        <div class="card">
                            <div class="row ">
                                ...
                                <div class="col-md-7 px-3">
                                    <div class="card-block px-3">
                                        <a href='file:///Users/teomoney1999/Downloads/jobfinder/job-info.html'><h4 class="card-title">Nguyen Ngoc Lan</h4></a>
    
                                        <p class="card-text"><i class="fa fa-usd" aria-hidden="true"></i><span id='salary'>You'll love it</span></p>
                                        <p class="card-text" id='script'>We are searching for 02 Testers. The job will perform following tasks:- Develop test plans, test procedures, test reports for financial system...</p>
                                        <div class='related'>
                                            <a href='#'><p class='related-item' id='first'>IELTS</p></a>
                                            <a href='#'><p class='related-item'>TOFEL</p></a>
                                            <a href='#'><p class='related-item'>TOEIC</p></a>
                                        </div>
                                    </div>
                                </div>
                                <div class='col-md-2'>
